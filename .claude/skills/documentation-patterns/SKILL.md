...
- [ ] ADR written for every architectural decision (≥1 per feature)
- [ ] CHANGELOG `[Unreleased]` updated with Added/Changed/Fixed entries
- [ ] JSDoc added to all new public service methods
- [ ] `.env.example` updated with any new environment variables
- [ ] All docs verified against actual implementation (not the plan)
